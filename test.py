#!/storage/public/home/2022124023/software/anaconda3/bin/python3  
import os
import argparse
import copy
...
def parse_args():
    ...
    parser.add_argument('-config', default='/storage/public/home/2022124023/DynStaticNet/configs/AIO_test/DDRNet.py', help='train config file path')
